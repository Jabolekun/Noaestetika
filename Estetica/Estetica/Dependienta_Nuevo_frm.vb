Public Class Dependienta_Nuevo_frm
    ...
    Private Sub Dependienta_Nuevo_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        DisableCloseButton(Me.Handle)
        fecha_txt.Text = Today.Date
    ...
    Private Sub guardar_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles guardar_bt.Click
        ...
        If movil_txt.Text = "" Then
            movil_txt.Text = 0
        End If
        If (MsgBox("Añadir nueva dependienta?", MsgBoxStyle.OkCancel, "AÑADIR") = MsgBoxResult.Ok) Then
            DependientasTA.Insert(nombre_txt.Text, apellidos_txt.Text, fijo_txt.Text, fecha_dtp.Value.Date, movil_txt.Text)
            MsgBox("GUARDADO OK", MsgBoxStyle.Information, "DEPENDIENTA AÑADIDA")
