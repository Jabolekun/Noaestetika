Public Class Menu_proveedores_frm
    ...
    Private Sub Menu_proveedores_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub historial_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles historial_bt.Click
        Dim frm As New Proveedor_Historial_frm
        frm.Show()
        Me.Hide()
    End Sub
