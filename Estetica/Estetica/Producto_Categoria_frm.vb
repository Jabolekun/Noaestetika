Public Class Producto_Categoria_frm
    ...
    Private Sub Producto_Categoria_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub guardar_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles guardar_bt.Click
        ...
        If (MsgBox("Añadir nueva categoría?", MsgBoxStyle.OkCancel, "AÑADIR") = MsgBoxResult.Ok) Then
            ProdcategoriasTA.Insert(categoria_txt.Text)
