Public Class Menu_Dependientas_frm
    ...
    Private Sub nuevo_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles nuevo_bt.Click
        Dim frm As New Dependienta_Nuevo_frm
        frm.Show()
        Me.Hide()
    End Sub

    Private Sub historial_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles historial_bt.Click
        Dim frm As New Dependienta_Historial_frm
        frm.Show()
        Me.Hide()
    End Sub

    Private Sub turnos_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles turnos_bt.Click
        Dim frm As New Dependienta_Horario_frm
        frm.Show()
        Me.Hide()
    End Sub
